...
class Nivel8:
	def __init__(self, j):
		...
		self.lbl1 = Label(j, text="Nível 8", fg="blue", font=('Times','20', 'bold'))
		self.lbl2 = Label(j, text="O rato ROEU a ROUPA DO Tei de ROMA.", fg="black", font=('Times','20', 'bold'))
		...
		self.lbl1.pack()
		self.lbl2.pack()
		self.txt.pack(ipadx=120, ipady=10)
		self.lbl3.pack()
		self.lbl4.pack()
