...
class Nivel9:
	def __init__(self, j):
		...
		self.lbl1 = Label(j, text="Nível 9", fg="blue", font=('Times','20', 'bold'))
		self.lbl2 = Label(j, text="1nFoRm4t1cA b45iCa", fg="black", font=('Times','20', 'bold'))
		...
		self.lbl1.pack()
		self.lbl2.pack()
		self.txt.pack(ipadx=5, ipady=10)
		self.lbl3.pack()
		self.lbl4.pack()
