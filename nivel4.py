...
class Nivel4:
	def __init__(self, j):
		...
		self.lbl1 = Label(j, text="Nível 4", fg="blue", font=('Times','20', 'bold'))
		self.lbl2 = Label(j, text="QuAl o MeU nOmE?", fg="black", font=('Times','20', 'bold'))
		...
		self.lbl1.pack()
		self.lbl2.pack()
		self.txt.pack(ipadx=10, ipady=10)
		self.lbl3.pack()
		self.lbl4.pack()
