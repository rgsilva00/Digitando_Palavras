...
class Nivel7:
	def __init__(self, j):
		...
		self.lbl1 = Label(j, text="Nível 7", fg="blue", font=('Times','20', 'bold'))
		self.lbl2 = Label(j, text="O sapo não lava o pé, não lava porque não quer.", fg="black", font=('Times','20', 'bold'))
		...
		self.lbl1.pack()
		self.lbl2.pack()
		self.txt.pack(ipadx=150, ipady=10)
		self.lbl3.pack()
		self.lbl4.pack()
